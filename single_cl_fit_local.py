if __name__ == "__main__":
    ...
    # filepath = 'C:/Users/cobia/OneDrive - University of Cambridge/CL/COBI-20250804/HYP-SHORTEND-01/HYPCard_corrected.hspy'
    # output_path = 'C:/Users/cobia/OneDrive - University of Cambridge/CL/COBI-20250804/HYP-SHORTEND-01/HYPCard_corrected.npy'

    numpy_folder = r"C:\Users\cobia\OneDrive - University of Cambridge\CL\numpy_fits"

    for i, filename in enumerate(cl_files):
        print(f"Processing file {i + 1}/{len(cl_files)}: {filename}")
        output_path = os.path.join(numpy_folder, f'{filename.split(os.path.sep)[-2]}_CL_SEM.npy')
        axis_path = os.path.join(numpy_folder, f'{filename.split(os.path.sep)[-2]}_axis.npy')
        cl_sem = hs.load(filename, signal_type='CL_SEM')
        cl_sem_eV_si = cl_sem.to_eV(inplace=False, jacobian=False)
        axis_values = cl_sem_eV_si.axes_manager[2].axis
        np.save(output_path, cl_sem_eV_si.data)
    ...
    output_path = 'C:/Users/cobia/OneDrive - University of Cambridge/CL/COBI-20250804/HYP-SHORTEND-01'
