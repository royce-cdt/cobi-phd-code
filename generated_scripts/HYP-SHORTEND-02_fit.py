if __name__ == "__main__":
    ...
    filepath = "/rds/user/cja69/hpc-work/python/cl_data/HYP-SHORTEND-02_CL_SEM.npy"
    axis_value_file = "/rds/user/cja69/hpc-work/python/cl_data/HYP-SHORTEND-02_axis.npy"
    output_log = "/rds/user/cja69/hpc-work/python/cl_data/HYP-SHORTEND-02_cl_fit.log"
    output_path = "/rds/user/cja69/hpc-work/python/cl_data/HYP-SHORTEND-02"
