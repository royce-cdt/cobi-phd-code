...
#SBATCH -o HYP-SHORTEND-04-REDO2_model_fit.out
#SBATCH -e HYP-SHORTEND-04-REDO2_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-SHORTEND-04-REDO2_fit.py
