...
#SBATCH -o HYP-SHORTEND09-REDO700-2_model_fit.out
#SBATCH -e HYP-SHORTEND09-REDO700-2_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-SHORTEND09-REDO700-2_fit.py
