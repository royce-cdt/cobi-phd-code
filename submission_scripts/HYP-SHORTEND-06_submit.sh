...
#SBATCH -o HYP-SHORTEND-06_model_fit.out
#SBATCH -e HYP-SHORTEND-06_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-SHORTEND-06_fit.py
