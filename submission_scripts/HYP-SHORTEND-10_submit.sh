...
#SBATCH -o HYP-SHORTEND-10_model_fit.out
#SBATCH -e HYP-SHORTEND-10_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-SHORTEND-10_fit.py
