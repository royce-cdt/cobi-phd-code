...
#SBATCH -o HYP-SHORTEND07-REDO700_model_fit.out
#SBATCH -e HYP-SHORTEND07-REDO700_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-SHORTEND07-REDO700_fit.py
