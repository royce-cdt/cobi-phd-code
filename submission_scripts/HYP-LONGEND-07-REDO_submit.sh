...
#SBATCH -o HYP-LONGEND-07-REDO_model_fit.out
#SBATCH -e HYP-LONGEND-07-REDO_model_fit.err
...
python /rds/user/cja69/hpc-work/python/generated_scripts/HYP-LONGEND-07-REDO_fit.py
